...
void CreateSetdrug(void)
{
	...
	BtnCreate(Setdrug_OBJ_BUTTON_7,5,		277,	66,		313,	5,BTN_DRAW,NULL,(GFX_XCHAR*)EXIT_OBJ_BUTTON_text,botbar);
//	BtnCreate(Setdrug_OBJ_BUTTON_8,92,277,152,313,5,BTN_DRAW,NULL,(GFX_XCHAR*)Setdrug_OBJ_BUTTON_8_text,botbar);
//	BtnCreate(Setdrug_OBJ_BUTTON_9,170,277,230,313,5,BTN_DRAW,NULL,(GFX_XCHAR*)Setdrug_OBJ_BUTTON_9_text,botbar);
