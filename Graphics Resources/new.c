 ...
 ***********************************/
const GFX_IMAGE_HEADER Wait_temp =
{
...
const GFX_IMAGE_HEADER Intro =
{
    (EDS_EPMP | IMAGE_MBITMAP | COMP_IPU),
    2,
    {    .edsAddress = (__eds__ char *) (0x000000A0 + GFX_EPMP_CS2_BASE_ADDRESS)   },
    226,
    166,
    2082,
    38036,
...
const GFX_IMAGE_HEADER Param_btn =
{
    (EDS_EPMP | IMAGE_MBITMAP | COMP_IPU),
    2,
    {    .edsAddress = (__eds__ char *) (0x000008D0 + GFX_EPMP_CS2_BASE_ADDRESS)   },
    224,
    26,
    86,
    6344,
...
const GFX_IMAGE_HEADER Wait1 =
{
    (EDS_EPMP | IMAGE_MBITMAP | COMP_IPU),
    2,
    {    .edsAddress = (__eds__ char *) (0x00000930 + GFX_EPMP_CS2_BASE_ADDRESS)   },
    28,
    28,
    672,
    1304,
...
const GFX_IMAGE_HEADER Wait2 =
{
    (EDS_EPMP | IMAGE_MBITMAP | COMP_IPU),
    2,
    {    .edsAddress = (__eds__ char *) (0x00000BD0 + GFX_EPMP_CS2_BASE_ADDRESS)   },
    28,
    28,
    700,
    1304,
...
const GFX_IMAGE_HEADER Wait3 =
{
    (EDS_EPMP | IMAGE_MBITMAP | COMP_IPU),
    2,
    {    .edsAddress = (__eds__ char *) (0x00000E90 + GFX_EPMP_CS2_BASE_ADDRESS)   },
    28,
    28,
    673,
    1304,
...
const GFX_IMAGE_HEADER Wait4 =
{
    (EDS_EPMP | IMAGE_MBITMAP | COMP_IPU),
    2,
    {    .edsAddress = (__eds__ char *) (0x00001140 + GFX_EPMP_CS2_BASE_ADDRESS)   },
    28,
    28,
    692,
    1304,
...
const GFX_IMAGE_HEADER Param_btn_press =
{
    (EDS_EPMP | IMAGE_MBITMAP | COMP_IPU),
    2,
    {    .edsAddress = (__eds__ char *) (0x00001400 + GFX_EPMP_CS2_BASE_ADDRESS)   },
    224,
    26,
    86,
    6344,
...
const GFX_IMAGE_HEADER Larrow_press =
{
    (EDS_EPMP | IMAGE_MBITMAP | COMP_IPU),
    2,
    {    .edsAddress = (__eds__ char *) (0x00001460 + GFX_EPMP_CS2_BASE_ADDRESS)   },
    55,
    30,
    388,
    2172,
...
const GFX_IMAGE_HEADER Rarrow_press =
{
    (EDS_EPMP | IMAGE_MBITMAP | COMP_IPU),
    2,
    {    .edsAddress = (__eds__ char *) (0x000015F0 + GFX_EPMP_CS2_BASE_ADDRESS)   },
    55,
    30,
    382,
    2172,
...
const GFX_IMAGE_HEADER Larrow =
{
    (EDS_EPMP | IMAGE_MBITMAP | COMP_IPU),
    2,
    {    .edsAddress = (__eds__ char *) (0x00001770 + GFX_EPMP_CS2_BASE_ADDRESS)   },
    55,
    30,
    256,
    3308,
...
const GFX_IMAGE_HEADER Rarrow =
{
    (EDS_EPMP | IMAGE_MBITMAP | COMP_IPU),
    2,
    {    .edsAddress = (__eds__ char *) (0x00001870 + GFX_EPMP_CS2_BASE_ADDRESS)   },
    55,
    30,
    256,
    3308,
...
const GFX_IMAGE_HEADER drug_Adrenaline =
{
    (EDS_EPMP | IMAGE_MBITMAP | COMP_IPU),
    2,
    {    .edsAddress = (__eds__ char *) (0x00001970 + GFX_EPMP_CS2_BASE_ADDRESS)   },
    102,
    54,
    383,
    6028,
...
const GFX_IMAGE_HEADER drug_Midazolam =
{
    (EDS_EPMP | IMAGE_MBITMAP | COMP_IPU),
    2,
    {    .edsAddress = (__eds__ char *) (0x00001AF0 + GFX_EPMP_CS2_BASE_ADDRESS)   },
    102,
    54,
    447,
    6028,
...
const GFX_IMAGE_HEADER drug_Morph_Midaz =
{
    (EDS_EPMP | IMAGE_MBITMAP | COMP_IPU),
    2,
    {    .edsAddress = (__eds__ char *) (0x00001CB0 + GFX_EPMP_CS2_BASE_ADDRESS)   },
    102,
    54,
    479,
    6028,
...
const GFX_IMAGE_HEADER drug_NoName =
{
    (EDS_EPMP | IMAGE_MBITMAP | COMP_IPU),
    2,
    {    .edsAddress = (__eds__ char *) (0x00001E90 + GFX_EPMP_CS2_BASE_ADDRESS)   },
    102,
    54,
    338,
    6028,
...
const GFX_IMAGE_HEADER drug_Noradrenaline =
{
    (EDS_EPMP | IMAGE_MBITMAP | COMP_IPU),
    2,
    {    .edsAddress = (__eds__ char *) (0x00001FF0 + GFX_EPMP_CS2_BASE_ADDRESS)   },
    102,
    54,
    891,
    6028,
...
const GFX_IMAGE_HEADER drug_Remitentanil =
{
    (EDS_EPMP | IMAGE_MBITMAP | COMP_IPU),
    2,
    {    .edsAddress = (__eds__ char *) (0x00002370 + GFX_EPMP_CS2_BASE_ADDRESS)   },
    102,
    54,
    358,
    6028,
...
const GFX_IMAGE_HEADER Wait5 =
{
    (EDS_EPMP | IMAGE_MBITMAP | COMP_IPU),
    2,
    {    .edsAddress = (__eds__ char *) (0x000024E0 + GFX_EPMP_CS2_BASE_ADDRESS)   },
    28,
    28,
    663,
    1304,
...
const GFX_IMAGE_HEADER Wait6 =
{
    (EDS_EPMP | IMAGE_MBITMAP | COMP_IPU),
    2,
    {    .edsAddress = (__eds__ char *) (0x00002780 + GFX_EPMP_CS2_BASE_ADDRESS)   },
    28,
    28,
    712,
    1304,
...
const GFX_IMAGE_HEADER Wait7 =
{
    (EDS_EPMP | IMAGE_MBITMAP | COMP_IPU),
    2,
    {    .edsAddress = (__eds__ char *) (0x00002A50 + GFX_EPMP_CS2_BASE_ADDRESS)   },
    28,
    28,
    673,
    1304,
...
const GFX_IMAGE_HEADER Wait8 =
{
    (EDS_EPMP | IMAGE_MBITMAP | COMP_IPU),
    2,
    {    .edsAddress = (__eds__ char *) (0x00002D00 + GFX_EPMP_CS2_BASE_ADDRESS)   },
    28,
    28,
    698,
    1304,
...
const GFX_IMAGE_HEADER prog_ContROV =
{
    (EDS_EPMP | IMAGE_MBITMAP | COMP_IPU),
    2,
    {    .edsAddress = (__eds__ char *) (0x00002FC0 + GFX_EPMP_CS2_BASE_ADDRESS)   },
    110,
    72,
    1115,
    8440,
...
const GFX_IMAGE_HEADER prog_ContVOT =
{
    (EDS_EPMP | IMAGE_MBITMAP | COMP_IPU),
    2,
    {    .edsAddress = (__eds__ char *) (0x00003420 + GFX_EPMP_CS2_BASE_ADDRESS)   },
    110,
    72,
    1181,
    8440,
...
const GFX_IMAGE_HEADER prog_IntROV =
{
    (EDS_EPMP | IMAGE_MBITMAP | COMP_IPU),
    2,
    {    .edsAddress = (__eds__ char *) (0x000038C0 + GFX_EPMP_CS2_BASE_ADDRESS)   },
    110,
    72,
    993,
    8440,
...
const GFX_IMAGE_HEADER prog_IntVOT =
{
    (EDS_EPMP | IMAGE_MBITMAP | COMP_IPU),
    2,
    {    .edsAddress = (__eds__ char *) (0x00003CB0 + GFX_EPMP_CS2_BASE_ADDRESS)   },
    110,
    72,
    991,
    8440,
...
const GFX_IMAGE_HEADER prog_PCA =
{
    (EDS_EPMP | IMAGE_MBITMAP | COMP_IPU),
    2,
    {    .edsAddress = (__eds__ char *) (0x00004090 + GFX_EPMP_CS2_BASE_ADDRESS)   },
    110,
    72,
    556,
    8440,
...
const GFX_IMAGE_HEADER prog_Step =
{
    (EDS_EPMP | IMAGE_MBITMAP | COMP_IPU),
    2,
    {    .edsAddress = (__eds__ char *) (0x000042C0 + GFX_EPMP_CS2_BASE_ADDRESS)   },
    110,
    72,
    530,
    8440,
...
const GFX_IMAGE_HEADER clock_img =
{
    (EDS_EPMP | IMAGE_MBITMAP | COMP_IPU),
    2,
    {    .edsAddress = (__eds__ char *) (0x000044E0 + GFX_EPMP_CS2_BASE_ADDRESS)   },
    128,
    128,
    4136,
    16904,
...
const GFX_IMAGE_HEADER Pointer_img =
{
    (EDS_EPMP | IMAGE_MBITMAP | COMP_IPU),
    2,
    {    .edsAddress = (__eds__ char *) (0x00005510 + GFX_EPMP_CS2_BASE_ADDRESS)   },
    12,
    12,
    133,
    664,
...
const GFX_IMAGE_HEADER Pressbar_img =
{
    (EDS_EPMP | IMAGE_MBITMAP | COMP_IPU),
    2,
    {    .edsAddress = (__eds__ char *) (0x000055A0 + GFX_EPMP_CS2_BASE_ADDRESS)   },
    33,
    199,
    118,
    7088,
...
const GFX_IMAGE_HEADER NoLimit =
{
    (EDS_EPMP | IMAGE_MBITMAP | COMP_IPU),
    2,
    {    .edsAddress = (__eds__ char *) (0x00005620 + GFX_EPMP_CS2_BASE_ADDRESS)   },
    50,
    31,
    298,
    2072,
...
const GFX_IMAGE_HEADER NoLimit_press =
{
    (EDS_EPMP | IMAGE_MBITMAP | COMP_IPU),
    2,
    {    .edsAddress = (__eds__ char *) (0x00005750 + GFX_EPMP_CS2_BASE_ADDRESS)   },
    50,
    31,
    257,
    2072,
...
const GFX_IMAGE_HEADER Bat8 =
{
    (EDS_EPMP | IMAGE_MBITMAP | COMP_IPU),
    2,
    {    .edsAddress = (__eds__ char *) (0x00005860 + GFX_EPMP_CS2_BASE_ADDRESS)   },
    24,
    30,
    328,
    1240,
...
const GFX_IMAGE_HEADER Bat1 =
{
    (EDS_EPMP | IMAGE_MBITMAP | COMP_IPU),
    2,
    {    .edsAddress = (__eds__ char *) (0x000059B0 + GFX_EPMP_CS2_BASE_ADDRESS)   },
    24,
    30,
    370,
    1240,
...
const GFX_IMAGE_HEADER Bat10 =
{
    (EDS_EPMP | IMAGE_MBITMAP | COMP_IPU),
    2,
    {    .edsAddress = (__eds__ char *) (0x00005B30 + GFX_EPMP_CS2_BASE_ADDRESS)   },
    24,
    30,
    288,
    1240,
...
const GFX_IMAGE_HEADER Bat2 =
{
    (EDS_EPMP | IMAGE_MBITMAP | COMP_IPU),
    2,
    {    .edsAddress = (__eds__ char *) (0x00005C50 + GFX_EPMP_CS2_BASE_ADDRESS)   },
    24,
    30,
    403,
    1240,
...
const GFX_IMAGE_HEADER Bat3 =
{
    (EDS_EPMP | IMAGE_MBITMAP | COMP_IPU),
    2,
    {    .edsAddress = (__eds__ char *) (0x00005DF0 + GFX_EPMP_CS2_BASE_ADDRESS)   },
    24,
    30,
    388,
    1240,
...
const GFX_IMAGE_HEADER Bat4 =
{
    (EDS_EPMP | IMAGE_MBITMAP | COMP_IPU),
    2,
    {    .edsAddress = (__eds__ char *) (0x00005F80 + GFX_EPMP_CS2_BASE_ADDRESS)   },
    24,
    30,
    382,
    1240,
...
const GFX_IMAGE_HEADER Bat5 =
{
    (EDS_EPMP | IMAGE_MBITMAP | COMP_IPU),
    2,
    {    .edsAddress = (__eds__ char *) (0x00006100 + GFX_EPMP_CS2_BASE_ADDRESS)   },
    24,
    30,
    374,
    1240,
...
const GFX_IMAGE_HEADER Bat6 =
{
    (EDS_EPMP | IMAGE_MBITMAP | COMP_IPU),
    2,
    {    .edsAddress = (__eds__ char *) (0x00006280 + GFX_EPMP_CS2_BASE_ADDRESS)   },
    24,
    30,
    353,
    1240,
...
const GFX_IMAGE_HEADER Bat7 =
{
    (EDS_EPMP | IMAGE_MBITMAP | COMP_IPU),
    2,
    {    .edsAddress = (__eds__ char *) (0x000063F0 + GFX_EPMP_CS2_BASE_ADDRESS)   },
    24,
    30,
    330,
    1240,
...
const GFX_IMAGE_HEADER Bat9 =
{
    (EDS_EPMP | IMAGE_MBITMAP | COMP_IPU),
    2,
    {    .edsAddress = (__eds__ char *) (0x00006540 + GFX_EPMP_CS2_BASE_ADDRESS)   },
    24,
    30,
    360,
    1240,
...
const GFX_IMAGE_HEADER setting =
{
    (EDS_EPMP | IMAGE_MBITMAP | COMP_IPU),
    2,
    {    .edsAddress = (__eds__ char *) (0x000066B0 + GFX_EPMP_CS2_BASE_ADDRESS)   },
    29,
    30,
    1386,
    1392,
...
const GFX_IMAGE_HEADER Speaker0 =
{
    (EDS_EPMP | IMAGE_MBITMAP | COMP_IPU),
    2,
    {    .edsAddress = (__eds__ char *) (0x00006C20 + GFX_EPMP_CS2_BASE_ADDRESS)   },
    36,
    36,
    483,
    1816,
...
const GFX_IMAGE_HEADER Speaker1 =
{
    (EDS_EPMP | IMAGE_MBITMAP | COMP_IPU),
    2,
    {    .edsAddress = (__eds__ char *) (0x00006E10 + GFX_EPMP_CS2_BASE_ADDRESS)   },
    36,
    36,
    681,
    1816,
...
const GFX_IMAGE_HEADER Speaker2 =
{
    (EDS_EPMP | IMAGE_MBITMAP | COMP_IPU),
    2,
    {    .edsAddress = (__eds__ char *) (0x000070C0 + GFX_EPMP_CS2_BASE_ADDRESS)   },
    36,
    36,
    905,
    1816,
...
const GFX_IMAGE_HEADER BatAC =
{
    (EDS_EPMP | IMAGE_MBITMAP | COMP_IPU),
    2,
    {    .edsAddress = (__eds__ char *) (0x00007450 + GFX_EPMP_CS2_BASE_ADDRESS)   },
    24,
    30,
    481,
    1240,
...
const GFX_IMAGE_HEADER BBat_img =
{
    (EDS_EPMP | IMAGE_MBITMAP | COMP_IPU),
    2,
    {    .edsAddress = (__eds__ char *) (0x00007640 + GFX_EPMP_CS2_BASE_ADDRESS)   },
    33,
    123,
    72,
    4580,
...
const GFX_IMAGE_HEADER BBat1_img =
{
    (EDS_EPMP | IMAGE_MBITMAP | COMP_IPU),
    2,
    {    .edsAddress = (__eds__ char *) (0x00007690 + GFX_EPMP_CS2_BASE_ADDRESS)   },
    33,
    123,
    72,
    4580,
...
const GFX_IMAGE_HEADER KVO =
{
    (EDS_EPMP | IMAGE_MBITMAP | COMP_IPU),
    2,
    {    .edsAddress = (__eds__ char *) (0x000076E0 + GFX_EPMP_CS2_BASE_ADDRESS)   },
    40,
    30,
    287,
    1720,
...
FONT_EXTERNAL Arial_Narrow_Bold_18 = 
{
    (EDS_EPMP | COMP_NONE),
    0x0002,
    (0x00007800 + GFX_EPMP_CS2_BASE_ADDRESS)
};
/*********************************
 * Installed Font Structure
...
FONT_EXTERNAL Arial_Narrow_26 = 
{
    (EDS_EPMP | COMP_NONE),
    0x0002,
    (0x00008520 + GFX_EPMP_CS2_BASE_ADDRESS)
};
/*********************************
 * Installed Font Structure
...
FONT_EXTERNAL Arial_Narrow_24 = 
{
    (EDS_EPMP | COMP_NONE),
    0x0002,
    (0x00009B60 + GFX_EPMP_CS2_BASE_ADDRESS)
};
/*********************************
 * Installed Font Structure
...
FONT_EXTERNAL Arial_Narrow_Bold_28 = 
{
    (EDS_EPMP | COMP_NONE),
    0x0002,
    (0x0000AFD0 + GFX_EPMP_CS2_BASE_ADDRESS)
};
/*********************************
 * Installed Font Structure
...
FONT_EXTERNAL Arial_Narrow_14 = 
{
    (EDS_EPMP | COMP_NONE),
    0x0002,
    (0x0000C970 + GFX_EPMP_CS2_BASE_ADDRESS)
};
/*********************************
 * Installed Font Structure
...
FONT_EXTERNAL Arial_Narrow_Bold_72 = 
{
    (EDS_EPMP | COMP_NONE),
    0x0002,
    (0x0000D1D0 + GFX_EPMP_CS2_BASE_ADDRESS)
};
/*********************************
 * Installed Font Structure
...
FONT_EXTERNAL Arial_Narrow_36 = 
{
    (EDS_EPMP | COMP_NONE),
    0x0002,
    (0x0000E4C0 + GFX_EPMP_CS2_BASE_ADDRESS)
};
/*********************************
 * Installed Font Structure
...
FONT_EXTERNAL Arial_Narrow_86 = 
{
    (EDS_EPMP | COMP_NONE),
    0x0002,
    (0x00010940 + GFX_EPMP_CS2_BASE_ADDRESS)
};
/*********************************
 * Installed Font Structure
...
FONT_EXTERNAL Arial_Narrow_Bold_86 = 
{
    (EDS_EPMP | COMP_NONE),
    0x0002,
    (0x00012090 + GFX_EPMP_CS2_BASE_ADDRESS)
};
