...
unsigned portBASE_TYPE uxtmpPriority = 0;

#if configKERNEL_INTERRUPT_PRIORITY != 2
...
const unsigned long ulCompareMatch = ( ( configCPU_CLOCK_HZ / portTIMER_PRESCALE ) / configTICK_RATE_HZ ) - 1;
	...
	PR5 = ( unsigned short ) ulCompareMatch;

	/* Setup timer 1 interrupt priority. */
	IPC7bits.T5IP = configKERNEL_INTERRUPT_PRIORITY;
