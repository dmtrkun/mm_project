...
#define portINTERRUPT_BITS			( ( unsigned portSHORT ) configKERNEL_INTERRUPT_PRIORITY )

extern unsigned portBASE_TYPE uxtmpPriority;

#define portDISABLE_INTERRUPTS()	{uxtmpPriority = SRbits.IPL; SRbits.IPL = portINTERRUPT_BITS;}                    
#define portENABLE_INTERRUPTS()		{SRbits.IPL = uxtmpPriority;}

#if 0
#define portDISABLE_INTERRUPTS()	{ \
/*    __asm__ volatile ("DISI #0x1FFF"); */\
    SR |= portINTERRUPT_BITS; \
/*	SRbits.IPL = 7;          enable CPU priority levels 4-7*/\
	DISICNT = 0; }
#define portENABLE_INTERRUPTS()		{ \
/*    __asm__ volatile ("DISI #0x1FFF"); */\
    SR &= ~portINTERRUPT_BITS; \
/*	SRbits.IPL = 0;          enable CPU priority levels 4-7*/\
    DISICNT = 0; }
#endif
