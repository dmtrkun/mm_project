...
/*********************************************************************
* Function: void PbWordToString(WORD value, XCHAR* buffer, XCHAR* unit)
*
...
*
********************************************************************/
void PbWordToString(WORD value, XCHAR *buffer, XCHAR* unit)
{
    WORD    result;
    BYTE    pos;
    if(unit == NULL)
    ...
    while(1)
    {
        ...
        switch(state)
        {
            ...
            case TEXT_DRAW2:
                ...
                if(pPb->unit == NULL)
                    PbWordToString((DWORD) pPb->pos * 100 / pPb->range, text, pPb->unit);
                else
                    PbWordToString((DWORD) pPb->pos, text, pPb->unit);
