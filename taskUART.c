...
char cChar;
	...
	RPINR19bits.U2RXR = 11; //RP11
	RPOR8bits.RP16R = 5;	//U2TX function
	__builtin_write_OSCCONL(OSCCON | 0x40);
// 	LATFbits.LATF3 = 1; //Set to 1  - disable motor
// 	LATDbits.LATD0 = 1; //Set to 1  - disable motor
...
//	TRISDbits.TRISD0 = 0; //Set as output
	...
	U2MODEbits.IREN		= serSET_FLAG;//serNO_IRDA;
