...
//	DmCreate(Test_OBJ_DIGITALMETER_3, 150, 186, 236, 224, DM_DRAW | DM_FRAME | DM_CENTER_ALIGN, 0, 5, 0, botbar);
	...
	GFX_GOL_ButtonCreate(Test_OBJ_BUTTON_7,5,277,66,313,5,BTN_DRAW,NULL,(GFX_XCHAR*)EXIT_OBJ_BUTTON_text,botbar);
	GFX_GOL_ButtonCreate(Test_OBJ_BUTTON_8,92,277,152,313,5,BTN_DRAW,NULL,(GFX_XCHAR*)Test_OBJ_BUTTON_8_text,botbar);
	GFX_GOL_ButtonCreate(Test_OBJ_BUTTON_9,170,277,230,313,5,BTN_DRAW,NULL,(GFX_XCHAR*)Test_OBJ_BUTTON_9_text,botbar);
