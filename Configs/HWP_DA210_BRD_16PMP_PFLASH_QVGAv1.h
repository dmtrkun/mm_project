...
#define GFX_USE_DISPLAY_PANEL_TFT_FSK430WQAV4F_420272


#if defined GFX_USE_DISPLAY_PANEL_TFT_G240320LTSW_118W_E

#define GFX_GCLK_DIVIDER 60 //61
...
//       #define      USE_TOUCHSCREEN_RESISTIVE         // use 4-wire resistive touch screen driver
       #define      USE_TOUCHSCREEN_AR1020         // use SPI touch screeen controller
#endif
...
//		#define DISP_ORIENTATION		90
        ...
        #define DISP_HOR_BACK_PORCH     4//12
        #define DISP_HOR_FRONT_PORCH    18
        #define DISP_VER_PULSE_WIDTH    5
        #define DISP_VER_BACK_PORCH     3//8
        #define DISP_VER_FRONT_PORCH    20
    	#define GFX_LCD_TYPE            GFX_LCD_TFT

		#if defined(GFX_USE_DISPLAY_CONTROLLER_MCHP_DA210)
//            #define GFX_DISPLAYENABLE_ENABLE        disabled for Hitachi
            #define GFX_HSYNC_ENABLE
            #define GFX_VSYNC_ENABLE
            #define GFX_DISPLAYPOWER_ENABLE
...
//    #define TouchScreenChipDirection()  TRISAbits.TRISA1 = 0
  ...
  //  #endif
    ...
    #define TouchScreenPacketReady()        (PORTCbits.RC13 == 1)
    #define TouchScreenConfigPacketReady()  {     TRISCbits.TRISC13 = 1; LATCbits.LATC13 = 0;ANSCbits.ANSC13 = 0;   }
    #else
...
* IO FOR THE BEEPER
*********************************************************************/
#define BEEP_TRIS_BIT   TRISGbits.TRISG7
#define BEEP_LAT_BIT    LATGbits.LATG7
