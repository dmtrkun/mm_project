...
#include "Flash_pgm/flash_programmer.h"
...
//DMK    DRV_NVM_SST25VF016_Initialize((DRV_SPI_INIT_DATA*)&SPI_Init_Data);
...
//DMK    SYSTEM_TickInit();
    ...
    // --------------------------------------------------------- 
//DMK    TouchInit(NVMWrite, NVMRead, NVMSectorErase, NULL);
