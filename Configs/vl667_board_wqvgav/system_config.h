...
#define GFX_EPMP_CS2_BASE_ADDRESS (GFX_EPMP_CS1_BASE_ADDRESS+GFX_EPMP_CS1_MEMORY_SIZE)
...
#define DRV_TOUCHSCREEN_FONT Gentium8
...
#define DataChipErase                  ((FLASH_CHIPERASE_FUNC)&SST39LF400ChipErase)
#define DataWrite                      ((FLASH_WRITE_FUNC    )&SST39LF400WriteArray)
#define DataRead                       ((FLASH_READ_FUNC     )&SST39LF400ReadArray)
