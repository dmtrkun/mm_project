...
// Strings
GFX_XCHAR Run_OBJ_STATICTEXT_0_text[] = "RUNNING";
GFX_XCHAR Run_OBJ_STATICTEXT_1_text[] = "ml/hr";

//const GFX_XCHAR Run_OBJ_STATICTEXT_2_text[] = "RATE";
//const GFX_XCHAR Run_OBJ_STATICTEXT_3_text[] = "VTBI";
//const GFX_XCHAR Run_OBJ_STATICTEXT_4_text[] = "INFUSED";
GFX_XCHAR Run_OBJ_STATICTEXT_5_text[] = "RATE=";

GFX_XCHAR Run_OBJ_STATICTEXT_6_text[] = "PUMPING\r\nPRESSURE";
const GFX_XCHAR Run_OBJ_STATICTEXT_7_text[] = "OCCLUSION\r\nLIMIT";
const GFX_XCHAR Run_OBJ_STATICTEXT_8_text[] = "RATE";

const GFX_XCHAR Run_OBJ_BUTTON_9_text[] = "MORE DISPLAY";
const GFX_XCHAR Run_OBJ_BUTTON_10_text[] = "BOLUS";
...
static GFX_GOL_OBJ_SCHEME* runScheme;
static GFX_GOL_OBJ_SCHEME* runScheme1;
static GFX_GOL_OBJ_SCHEME* runScheme2;
static GFX_GOL_OBJ_SCHEME* runGrayScheme;

void RunShemes(void)
{
	runScheme = CreateScheme();
	memcpy(runScheme, defscheme, sizeof(GFX_GOL_OBJ_SCHEME));
	...
	runScheme1 = CreateScheme();
	memcpy(runScheme1, runScheme, sizeof(GFX_GOL_OBJ_SCHEME));
	runScheme1->pFont = (void*) &Arial_Narrow_Bold_86;
	
	runScheme2 = CreateScheme();
	memcpy(runScheme2, runScheme, sizeof(GFX_GOL_OBJ_SCHEME));
	runScheme2->pFont = (void*) &Arial_Narrow_24;
	 
	runGrayScheme = CreateScheme();
	memcpy(runGrayScheme, defscheme, sizeof(GFX_GOL_OBJ_SCHEME));
...
void CreateRun(void)
{
	...
	{                           
		...
		GFX_GOL_StaticTextCreate(Run_OBJ_STATICTEXT_5,1,185,178,280,GFX_GOL_STATICTEXT_DRAW_STATE,(GFX_XCHAR*)str1,GFX_ALIGN_CENTER,runScheme1);
		GFX_GOL_StaticTextCreate(Run_OBJ_STATICTEXT_8,88,156,152,189,GFX_GOL_STATICTEXT_DRAW_STATE,(GFX_XCHAR*)Run_OBJ_STATICTEXT_8_text,GFX_ALIGN_CENTER,runScheme);
		GFX_GOL_StaticTextCreate(Run_OBJ_STATICTEXT_1,174,240,239,278,GFX_GOL_STATICTEXT_DRAW_STATE,(GFX_XCHAR*)Run_OBJ_STATICTEXT_1_text,GFX_ALIGN_CENTER,runScheme);
	}
	else
	{
		GFX_GOL_StaticTextCreate(Run_OBJ_STATICTEXT_6,42,54,135,92,GFX_GOL_STATICTEXT_DRAW_STATE|GFX_GOL_STATICTEXT_DISABLED_STATE,(GFX_XCHAR*)Run_OBJ_STATICTEXT_6_text,GFX_ALIGN_CENTER,runGrayScheme);
		GFX_GOL_StaticTextCreate(Run_OBJ_STATICTEXT_7,42,198,135,236,GFX_GOL_STATICTEXT_DRAW_STATE|GFX_GOL_STATICTEXT_DISABLED_STATE,(GFX_XCHAR*)Run_OBJ_STATICTEXT_7_text,GFX_ALIGN_CENTER,runGrayScheme);
	
		sprintf(str1,"%d mmHg",press2_mmHg);
		EbCreate(Run_OBJ_EDITBOX_0,42,96,135,122, EB_DRAW,(GFX_XCHAR*)str1, 50 ,runGrayScheme);
...
//		while(!GFX_BarDraw(168, 260 - press2hight(press2_mmHg)/*66*/,188,260));
	}
}
...
WORD msgRun(WORD objMsg, GFX_GOL_OBJ_HEADER* pObj, GFX_GOL_MESSAGE* pMsg)
{
...
void CreateRun_prog1(void)
{
		...
		EbCreate(Run_OBJ_EDITBOX_2,3,48,236,86,EB_DRAW,(GFX_XCHAR*)str1,50,runScheme);
		...
		EbCreate(Run_OBJ_EDITBOX_3,3,94,236,132,EB_DRAW,(GFX_XCHAR*)str2,50,runScheme);
	
		sprintf(str3,"INFUSED = ");
		ValToStr(TYPE_VOLUME,0, vol_para.infsd,NULL, str3 + strlen(str3));
		EbCreate(Run_OBJ_EDITBOX_4,3,140,236,178, EB_DRAW,(GFX_XCHAR*)str3, 50 ,runScheme);
}
