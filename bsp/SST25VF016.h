...
#ifdef SST25VF016_PUB
#define SST25VF016PUB
#else
#define SST25VF016PUB extern
#endif

#define SST25_sector_0         0
#define SST25_sector_1         0x1000
#define CLBR_E2PIMG_BASE       SST25_sector_0
#define PARAM_E2PIMG_BASE      SST25_sector_1

SST25VF016PUB BYTE SST25ReadByte(DWORD address);
SST25VF016PUB BYTE SST25ReadStat(void);
