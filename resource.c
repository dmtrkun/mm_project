...
extern GFX_FONT_SPACE char __Gentium8[] __attribute__((section("grc_text"), aligned(2)));
#else
extern GFX_FONT_SPACE char __Gentium8[] __attribute__((section("grc_text")));
#endif
#else
extern GFX_FONT_SPACE char __Gentium8[] __attribute__((aligned(2)));
#endif

const GFX_RESOURCE_HDR Gentium8 = 
{
    .type = (GFX_RESOURCE_MEMORY_FLASH | GFX_RESOURCE_TYPE_FONT | GFX_RESOURCE_COMP_NONE),
    .ID = 0x0000,
    .resource.font.location.progByteAddress = (GFX_FONT_SPACE char *) __Gentium8,
    ...
    .resource.font.header.firstChar = 0x001C,
    .resource.font.header.lastChar = 0x007F,
    .resource.font.header.height = 0x000E,
};
